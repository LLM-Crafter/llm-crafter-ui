...
<div class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 p-4">
	<div
		class="flex max-h-[90vh] w-full max-w-4xl flex-col overflow-hidden rounded-xl bg-white shadow-2xl dark:bg-gray-900"
	>
		<!-- Modal Header -->
		<div
			class="flex flex-shrink-0 items-center justify-between border-b border-gray-200 p-6 dark:border-gray-700"
		>
		...
		<!-- Modal Footer -->
		<div
			class="flex flex-shrink-0 items-center justify-between border-t border-gray-200 p-6 dark:border-gray-700"
		>
