		...
		<div class="flex items-center justify-between">
			<div class="flex items-center space-x-4">
				...
				<div>
					...
					<p class="text-gray-400">Manage your AI projects and collaborate with your team</p>
				</div>
			</div>
			<button
				class="flex items-center space-x-2 rounded-xl bg-gradient-to-r from-blue-600 to-purple-600 px-6 py-3 font-medium text-white transition-all duration-200 hover:from-blue-700 hover:to-purple-700 hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-gray-950"
	...
	{#if data.projects.length > 0}
		<div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
			{#each filteredProjects as project, index}
				<div
					class="group relative cursor-pointer overflow-hidden rounded-xl border border-gray-700 bg-gray-800/30 p-6 shadow-lg backdrop-blur-sm transition-all duration-200 hover:border-gray-600 hover:bg-gray-800/50 hover:shadow-xl hover:shadow-blue-500/10"
				...
				>
					...
					{:else}
						<p class="mb-4 text-sm italic text-gray-500">No description provided</p>
					{/if}
					...
					<div class="w-full">
						<a
							...
							class="flex w-full items-center justify-center space-x-2 rounded-lg bg-blue-600 px-4 py-2.5 text-white transition-all hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-gray-800"
						>
		...
		<div class="flex min-h-[400px] items-center justify-center">
			<div class="text-center">
				<div class="mb-6">
					...
					<h3 class="mb-2 text-2xl font-semibold text-gray-100">No Projects Yet</h3>
