...
<div class="min-h-screen">
	...
	<div class="mb-8">
		<div class="flex items-center justify-between">
			<div class="flex items-center space-x-4">
				...
				<div>
					<h1 class="text-3xl font-bold text-gray-100">AI Agents</h1>
					<p class="text-gray-400">Manage intelligent agents for {data.project.name}</p>
				</div>
			</div>
		...
		<nav class="mt-4 flex items-center space-x-2 text-sm text-gray-400">
			...
			>
			<i class="fas fa-chevron-right text-xs"></i>
			<span class="text-gray-200">Agents</span>
		</nav>
	</div>
		...
		<div class="border-b border-gray-800">
			<nav class="-mb-px flex space-x-8">
				...
				<a
					...
					class="flex items-center space-x-2 border-b-2 border-indigo-500 px-1 py-4 text-sm font-medium text-indigo-400"
				>
	...
	<div class="mb-8 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
		<div class="rounded-xl border border-gray-800 bg-gray-900 p-6">
			<div class="flex items-center justify-between">
				<div>
					...
					<p class="text-2xl font-bold text-gray-100">{agents.length}</p>
				</div>
		...
		<div class="rounded-xl border border-gray-800 bg-gray-900 p-6">
			<div class="flex items-center justify-between">
				<div>
					<p class="text-sm font-medium text-gray-400">Chatbots</p>
		...
		<div class="rounded-xl border border-gray-800 bg-gray-900 p-6">
			<div class="flex items-center justify-between">
				<div>
					<p class="text-sm font-medium text-gray-400">Task Agents</p>
					<p class="text-2xl font-bold text-green-400">
	...
	<div class="rounded-xl border border-gray-800 bg-gray-900">
		...
		<div class="border-b border-gray-800 p-6">
			...
			>
				<div>
					<h2 class="text-xl font-semibold text-gray-100">Agent Management</h2>
					<p class="text-sm text-gray-400">Create and manage intelligent AI agents</p>
				</div>
				...
				<div class="flex items-center space-x-3">
					<div class="relative">
						...
						<input
							...
							class="w-64 rounded-lg border border-gray-700 bg-gray-800 py-2 pl-10 pr-4 text-gray-100 placeholder-gray-400 focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500"
						/>
					</div>
					<select
						bind:value={filterType}
						class="rounded-lg border border-gray-700 bg-gray-800 px-3 py-2 text-gray-100 focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500"
					>
					...
					{#each filteredAgents as agent}
						...
						>
							...
							<div class="absolute right-4 top-4 flex items-center space-x-2">
								...
								{:else}
									<span
										class="inline-flex items-center rounded-full bg-gray-500/10 px-2.5 py-0.5 text-xs font-medium text-gray-400"
									>
							...
							<div class="mb-4 mt-8">
								<a
									...
									class="mb-2 block text-lg font-semibold text-gray-100 transition-colors hover:text-white"
								>
									{agent.name}
								</a>
							...
							{#if agent.llm_settings?.model}
								<div class="mb-4 rounded-lg bg-gray-700/50 p-3">
									<div class="flex items-center justify-between text-sm">
										<span class="text-gray-400">Model:</span>
										<span class="font-medium text-gray-200">{agent.llm_settings.model}</span>
									</div>
								...
								<div class="mb-4">
									<div class="flex flex-wrap gap-1">
										...
										{#if agent.tools.length > 3}
											<span
												class="inline-flex items-center rounded-md bg-gray-500/10 px-2 py-1 text-xs font-medium text-gray-400"
											>
	...
	<div class="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
		<div class="mx-4 w-full max-w-md rounded-xl border border-gray-800 bg-gray-900 p-6 shadow-2xl">
			<div class="mb-4 flex items-center space-x-3">
				...
				<div>
					<h3 class="text-lg font-semibold text-gray-100">Delete Agent</h3>
					<p class="text-sm text-gray-400">This action cannot be undone</p>
				</div>
			</div>

			<p class="mb-6 text-gray-300">
				Are you sure you want to delete <strong class="text-white">"{agentToDelete.name}"</strong>?
